...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ChannelsSpec(pub Vec<ChannelDesc>);
...
pub enum ChannelData {
    Scalar2D { name: String, width: u32, height: u32, data: Vec<f32> },
    Scalar3D { name: String, width: u32, height: u32, depth: u32, data: Vec<f32> },
}
